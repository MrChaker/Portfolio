...
const Progress = () => {
  ...
  useEffect(() => {
    ...
    if (pr.current) pr.current.style.width = `${window.scrollY * fraction}px`
  ...
  return (
    <div
      ref={pr}
      className="fixed h-[4.8rem] sm:h-20 z-[29] bg-gradient-to-r from-blue-500 dark:from-blue-700 to-pink-500 dark:to-pink-600 transition Glowing"
    ></div>
  )
}
